...
The results show a Microsoft IIS 6.0 web server running on port 80. The following steps will be oriented to collect information about the server and try to exploit it to get access to the system.
