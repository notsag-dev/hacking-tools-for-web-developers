...
The results show a Microsoft IIS web server running on port 80. The tools that will be used from now on will be oriented to collect information about this server and try to exploit it to get access to the system.
